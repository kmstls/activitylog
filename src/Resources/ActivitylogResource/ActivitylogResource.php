...
class ActivitylogResource extends Resource
{
    ...
    protected static function getResourceUrl(Activity $record): string
    {
        ...
        if ($record->subject_type && $record->subject_id) {
            try {
                ...
                // If there's any error generating the URL, return a placeholder
                return '#';
            }
        }
    ...
    public static function getDatePickerComponent(string $label): DatePicker
    {
    ...
    public static function getDateFilterComponent(): Filter
    {
        return Filter::make('created_at')
            ...
            ->schema([
                self::getDatePickerComponent('created_from'),
                self::getDatePickerComponent('created_until'),
            ])
